    ...
    renderBottomControls() {
        return(
            ...
            <Image
                ...
                style={[ {flexDirection:'row',height:null,width:null} , styles.controls.vignette,
            ]}>  
                ...
                <View style={{flex:2,flexDirection:'row',alignItems:'center'}}>
                     <View style={{flex:1}}>{ this.renderTimer() }</View>
                   {  
                     //<View style={{flex:1,paddingLeft:15}}>{ this.renderVolume() }</View>
                     //<View style={{flex:1}}>{ this.renderFullscreen() }</View>
                   }
                </View>
            </Image>
            </Animated.View>
        ...
        return (
            <View style={{flex:1}}>
                <TouchableWithoutFeedback
                    ...
                    style={[ styles.player.container, this.styles.containerStyle,{backgroundColor:'#fff'} ]}
                >
                    <View style={[ styles.player.container, this.styles.containerStyle ,{backgroundColor:'#f00'}]}>
                        <Video
                ...
                <ScrollView style={{position:'absolute',top:210,left:0,backgroundColor:'#Fff',height:wsize.height-200,width:wsize.width}}>
                        {this.props.children}
                </ScrollView>
            </View>
        );
