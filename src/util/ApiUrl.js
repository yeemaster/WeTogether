export const apiUrl = {
	'API_THEMES_URL' : 'http://news-at.zhihu.com/api/4/themes', //分类
	'API_LATEST_URL' : 'http://news-at.zhihu.com/api/4/news/latest',  //最新资讯
	'API_THEME_URL' : 'http://news-at.zhihu.com/api/4/theme/',  //分类明细表
	'API_NEWDETAIL_URL' : 'http://news.at.zhihu.com/api/4/news/', // 咨询明细
	'API_NEWDETAIL_WEBURL' : 'http://daily.zhihu.com/story/',  //网页
	'API_FILMLIST_URL' : 'http://m.maoyan.com/movie/list.json?type=hot&offset=0&limit=20',  //电影列表
	'API_FILMDETAIL_URL' : 'http://m.maoyan.com/movie/',  //电影详情
	'API_MUSICHOTLIST_URL' : 'http://tingapi.ting.baidu.com/v1/restserver/ting?format=json&calback=&from=webapp_music&method==baidu.ting.billboard.billList&type=2&size=20&offset=0', //热歌版
	'API_MUSICSONGPLAYER_URL' : 'http://tingapi.ting.baidu.com/v1/restserver/ting?format=json&calback=&from=webapp_music&method=baidu.ting.song.play&songid=',
